...
\begin{ganttchart}[
  ...
  \ganttgroup[progress=100]{Scope and planning}{2}{2} \\
  \ganttbar[
    progress=100,
    name=WBS1A
  ...
  \ganttgroup[progress=100]{State of art research}{3}{5} \\
  \ganttbar[progress=100]{Search bibliography}{3}{5} \\
  \ganttbar[progress=100]{Search similar code projects}{4}{5} \\
  \ganttbar[progress=100]{Resume state of art, redefine aims}{4}{5}\\[grid]
  
  \ganttgroup[progress=100]{Project development}{6}{14} \\
  \ganttbar[progress=100]{Data preparation}{6}{6} \\
  \ganttbar[progress=100]{Deep Learning Design}{6}{7} \\
  \ganttbar[progress=100, name=cod]{Deep Learning codification}{7}{9}\\
  \ganttbar[progress=100, name=exe]{Experiment execution}{10}{12}\\
  \ganttbar[progress=100]{Discuss results, improvements}{12}{13}\\
  \ganttbar[progress=100]{Update documentation}{14}{14}\\[grid]
  
  \ganttgroup[progress=100]{Documentation}{15}{16} \\[grid]
  
  \ganttgroup[progress=99]{Presentation and defence}{17}{17} \\
...
The phases of CRISP-DM \cite{crisp} are the following:
\begin{description}
